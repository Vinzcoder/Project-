/* shared.js — sumber kebenaran tunggal: peta, senjata, aturan, raycast.
   Dipakai oleh server.js (Node) dan index.html (browser). */
...
const MAP = {
  ...
  spawns: {
    A: [[-9,-26.5],[-4.5,-26.5],[0,-27],[4.5,-26.5],[9,-26.5]],   // menghadap +z
    B: [[-9, 26.5],[-4.5, 26.5],[0, 27],[4.5, 26.5],[9, 26.5]],   // menghadap -z
  },
};
...
/* Daftar AABB solid (cover + 4 dinding perimeter) — dipakai server (hit) & klien (visual). */
